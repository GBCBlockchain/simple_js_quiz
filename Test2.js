//1. Here is a sample html file with a submit button. Now modify the style of the paragraph text through javascript 
//code. Go to the editor
//Sample HTML file :
...
<div>
<button id="jsstyle"
onclick="function1()">Style</button>
</div>
function function1() {
    document.getElementById("text").textContent="JavaScript Excersises_changed";
}
function1();
...
// Here is a sample html file with a submit button. Write a JavaScript function to get the value of
 //the href, hreflang, rel, target, and type attributes of the specified link. Go to the editor
`
<!DOCTYPE html>
<html><head>
<meta charset=utf-8 />
...
function getAttributes()
{
 ...
 var d = document.getElementById("w3r").target; 
  alert('The value of the taget attribute of the link is : '+xd);
...
6. Write a JavaScript function that accept row, column, (to identify a particular cell) and a string to update
 the content of that cell. Go to the editor
Sample HTML file :
`
<!DOCTYPE html>
<html><head>
